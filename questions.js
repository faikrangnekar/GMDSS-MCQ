...
const questionSets = {
  ...
  set13: [
    ...
    },
    {
      ...
      options: [
        ...
        "The",
        "maintenance may be waived if the compulsory vessel carries at least three licensed GMDSS Radio Operators.",
  ...
  set15: [
    ...
    },
    {
      ...
      options: [
        "Into an artificial antenna.",
        "May be accomplished by using the radiotelephone for normal business.",
        "On 2182 kHz and must be heard clearly under normal conditions at a range of 150 nautical miles.",
        "Either a) or b).",
      ],
      answer: 3
    },
  ...
  set17: [
    ...
    },
    {
      ...
      options: [
        ...
        "All Coast Station MMSI must be 9 digits and begin with 2 zeros followed by the MID.",
        "None of the above.",
      ],
      answer: 2
    },
    ...
    },
    {
      ...
      options: [
        ...
        "Vessel's position will automatically be sent if the vessel is sending a",
        "alert.",
  ...
  set18: [
    ...
    },
    {
      ...
      options: [
        ...
        "The transmission is not initiated and",
        "is indicated on the display readout.",
    ...
    },
    {
      ...
      options: [
        "Will send the minimal necessary information using the",
        "or",
        "",
  ...
  set19: [
    {
      ...
      options: [
        "Make an",
        "call on all 5 H.F. telex channels canceling the alert.",
        "Make an",
        "call on 8291.0 kHz canceling the alert.",
        "Make a",
        "call on 8414.5 kHz canceling the alert.",
        "Make an",
        "call on 8614.0 kHz canceling the alert.",
      ],
      answer: 1
    },
    {
      ...
      options: [
        "No action is necessary.",
        "Make an",
        "call on all 5 H.F. telex frequencies canceling the alert.",
        "Make an",
        "call on the associated 12 MHz J3E frequency canceling the alert.",
    ...
    },
    {
      ...
      options: [
        ...
        "key.",
        "Select",
        "menu and send a cancel message via the CES used for the distress alert.",
        "Both of the above.",
        "None of the above.",
      ],
      answer: 1
    },
    {
      ...
      options: [
        ...
        "To ensure that a distressed vessel will have a",
        "twice each hour for transmitting routine messages.",
    ...
    },
    {
      ...
      options: [
        ...
        "Two three-minute silent periods, at 15 and 45 minutes after the hour, that provide a transmitting",
        "for distressed vessels to transmit distress alerts using J3E.",
    ...
    {
      question: "The Radiotelephone Safety signal is:",
      options: [
        "",
        "repeated 3 times.",
        "",
    ...
    },
    {
      ...
      options: [
        ...
        "position and secure them to the survival craft.",
  ...
  set20: [
    ...
    },
    {
      ...
      options: [
        ...
        "It informs survivors when the battery's charge condition has weakened.",
        "It informs survivors when the SART switches to the",
        "mode.",
    ...
    },
    {
      ...
      options: [
        "The SART will provide a visual or audible indication of interrogation by a 3-cm radar.",
        "The Satellite EPIRB will emit an audible signal.",
        "The VHF portable radio will emit an audible alarm signal on 156.525 MHz.",
    ...
    },
    {
      ...
      options: [
        "It immediately begins radiating when placed in the",
        "position.",
        "It must be manually activated.",
        "If it has been placed in the",
        "position, it will respond when it has been interrogated by a 9-GHz radar signal.",
        "If it has been placed in the",
        "position, it will begin transmitting immediately upon detecting that it is in water.",
      ],
      answer: 2
    },
    {
    ...
    },
    {
      ...
      options: [
        "It transmits",
        "and the vessel's name and position in slow speed Morse Code.",
    ...
    },
    {
      ...
      options: [
        ...
        "This is a 9 GHz transponder capable of being received by another vessel's X-band navigational radar system.",
    ...
    },
    {
      ...
      options: [
        "Excessive testing causes",
        "on the vessel's radar PPI.",
        "Testing a SART should be performed only in controlled environment as a test signal may be misinterpreted as a genuine distress situation.",
  ...
  set21: [
    ...
    },
    {
      question: "With what other stations may portable survival craft transceivers communicate?",
      options: [
        "Communications is permitted between survival craft.",
        "Communications is permitted between survival craft and ship.",
        "Communications is permitted between survival craft and rescue unit.",
        "All of the above.",
      ],
    ...
    },
    {
      ...
      options: [
        ...
        "Ch-2182",
        "Ch-70",
        "Ch-16 on VHF radiotelephone and 2174.5 kHz using MF SITOR.",
      ],
      answer: 3
    },
    {
  ...
  set22: [
    ...
    },
    {
      ...
      options: [
        ...
        "output position resulting in receiver overloading.",
    ...
    },
    {
      ...
      options: [
        "Selects Duplex operations for U.S. coastal waters and Simplex operations in non-U.S. waters on the",
        "channels.",
    ...
    },
    {
      ...
      options: [
        ...
        "Correctly set, will result in Duplex operations in U.S. Coastal waters on the",
        "channels.",
        "Correctly set, will result in Simplex operations in U.S. Coastal waters on the",
        "channels.",
        "Both a) and c) are true.",
      ],
      answer: 3
    ...
    },
    {
      question: "Which of the following statements is true?",
      options: [
        "The GMDSS Radio Operator can program the NAVTEX receiver to automatically reject any category of messages under the master's authority.",
        "The GMDSS Radio Operator can program the NAVTEX receiver to reject all messages except navigation warnings, meteorological warnings, and search and rescue information.",
        "The GMDSS Radio Operator can select the",
        "option in the message category menu.",
        "Upon entering a new NAVTEX station's broadcast range, the GMDSS Radio Operators enters the station's selcall number.",
      ],
      answer: 1
    },
    {
  ...
  set23: [
    ...
    },
    {
      ...
      options: [
        ...
        "There is no loss of information since broadcasts of",
  ...
  set25: [
    ...
    },
    {
      ...
      options: [
        "Fax.",
        "Telex",
        "Voice Communications, compandors off.",
    ...
    },
    {
      question: "Which statement concerning Inmarsat-A and Inmarsat-C terminals is correct?",
      options: [
        "Inmarsat-A terminals require gyro and GPS input to enable automatic satellite tracking.",
        "Inmarsat-C terminals require only GPS input to enable automatic satellite tracking.",
        "Inmarsat-A terminals require AZ/EL setup and gyro input to enable automatic satellite tracking.",
        "Inmarsat-C terminals require AZ/EL setup and GPS input to enable automatic satellite tracking.",
      ],
      answer: 2
    },
    {
      ...
      options: [
        ...
        "Inmarsat-A antennas are larger, with passive non-parabolic antennas that require rewind capability.",
        "Inmarsat-C antennas are smaller, with passive non-parabolic antennas but no rewind capability.",
        "Inmarsat-A antennas are larger, with parabolic antennas but no rewind capability.",
      ],
      answer: 2
    },
    {
      question: "Which statement concerning Inmarsat-A and Inmarsat-C terminals is correct?",
      options: [
        "Both Inmarsat-A and Inmarsat-C units are subject to shadowing effects due to their omni-directional antennas.",
        "Both Inmarsat-A and Inmarsat-C units are subject to shadowing effects but Inmarsat-A units have directional antennas.",
        "Both Inmarsat-A and Inmarsat-C units are subject to shadowing effects but Inmarsat-C units have directional antennas.",
        "Both Inmarsat-A and Inmarsat-C units are subject to shadowing effects due to their directional antennas.",
      ],
      answer: 1
    },
    {
      question: "When Inmarsat-A and Inmarsat-C terminals are compared:",
      options: [
        "Inmarsat-A units provide greater communications capabilities with the benefits of greater size/weight, installation expense and initial cost.",
        ...
        "Inmarsat-A units provide greater communications capabilities with the trade-offs of greater size/weight, installation expense and initial cost.",
  ...
  set26: [
    ...
    },
    {
      ...
      options: [
        "Dial 11# on the keypad after receiving the",
        "tone.",
        "Type 00+ after receiving the",
        "by the shore station.",
        "Type 11+ after receiving the",
        "by the shore station.",
        "Type 001 after receiving the",
        "by the shore station.",
      ],
      answer: 2
    },
    {
      ...
      options: [
        "36#",
        "The digits 00 followed by the country code, the credit card number, the expiration date and ending with the",
        "sign.",
        "Credit card billing is impossible via Inmarsat.",
        "The Shore I.D. and",
        "sign followed by the digits 00, then the Country Code, subscriber's number and ending with the",
        "sign.",
      ],
      answer: 0
    },
    {
      ...
      options: [
        ...
        "8741502773",
        "584436671929",
        "Either a) or c) are correct, depending on the Inmarsat system addressed.",
      ],
      answer: 3
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "5821506692",
        "582436377125",
        "All may be correct, depending on the Inmarsat system addressed.",
      ],
      answer: 3
    },
    {
  ...
  set27: [
    ...
    },
    {
      ...
      options: [
        ...
        "By adding the word",
        "in the first line of the message's preamble.",
    ...
    },
    {
      ...
      options: [
        "By dialing the correct code on the telephone remote unit.",
        "By pressing one or more dedicated",
        "on the equipment.",
        "By contacting the CES operator, and announcing a distress condition is in existence.",
        "By contacting the CES operator using the radiotelephone distress procedure",
      ],
    ...
    },
    {
      ...
      options: [
        "Depress the",
        "switch to disconnect incoming message.",
        "Depressing the",
        "button automatically disconnects incoming messages.",
  ...
  set28: [
    ...
    },
    {
      ...
      options: [
        ...
        "To the highest level possible so as to ensure other stations cannot",
    ...
    {
      question: "Which is a valid ITU Designation?",
      options: [
        "Ch-1604",
        "Ch-706",
        "",
  ...
  set29: [
    ...
    },
    {
      ...
      options: [
        "The vessel listens for",
        "and calls the public correspondence station on the NBDP calling channel with the strongest marker signal.",
    ...
    },
    {
      ...
      options: [
        "On a properly selected ITU channel, give the call sign of the ship being called three times using the ICAO alphabet, and the words",
        "followed by the call sign of the ship initiating the call three times, using the ICAO alphabet, and concluding with",
        "",
        "Give the name of the ship being called three times, and the words",
        "followed by the name of the ship initiating the call three times, and concluding with",
        "",
    ...
    {
      question: "What is the correct procedure for calling a coast radio station using HF radiotelephone?",
      options: [
        "On a properly selected ITU channel, give the name of the coast radio station being called three times, and the words",
        "followed by the name of the ship initiating the call three times, and concluding with",
        ".",
        "Contact the nearest U.S.C.G. station to add the desired ship's call sign to the station's traffic list.",
        "On a properly selected ITU channel, give the call sign of the coast radio station being called three times using the ICAO alphabet, and the words",
        "followed by the call sign of the ship initiating the call three times, using the ICAO alphabet, and concluding with",
        ".",
    ...
    },
    {
      ...
      options: [
        ...
        "FEC transmissions require a",
        "or",
        "process prior to character transmission.",
        "FEC transmissions rely upon error correction by time diversity transmission and reception.",
        "FEC transmissions rely upon parity and",
    ...
    },
    {
      ...
      options: [
        ...
        "Monitor the coast radio station's",
        "and call on the frequency on which the loudest and most consistent signals are heard.",
        "Re-position the radome's antenna toward the coast radio station and press the",
        "button.",
      ],
      answer: 2
    },
  ...
  set30: [
    ...
    },
    {
      ...
      options: [
        ...
        "If the operator enters",
        "",
        "If any of the above actions takes place.",
      ],
      answer: 3
    },
    {
      question: "Which of the following keystrokes or characters is sent as part of ARQ communications to end the radio link?",
      options: [
        "Four",
        "s, i.e.",
        ".",
    ...
    {
      question: "What character(s) are transmitted to switch control from a station currently transmitting, over to the receiving station during ATOR communications in the ARQ mode?",
      options: [
        "",
        "",
        "",
    ...
    {
      question: "What are the characters that are transmitted to terminate a direct telex connection in SITOR operation?",
      options: [
        "",
        "",
        "KKKK",
    ...
    },
    {
      ...
      options: [
        ...
        "In ARQ, the",
        "transmits a block of three characters twice, about 250 milliseconds apart.",
        "In ARQ, the",
        "will transmit a block of three characters that the receiving station will subsequently acknowledge or request be retransmitted.",
    ...
    },
    {
      ...
      options: [
        ...
        "In ARQ, the",
        "station transmits a block of three characters and the",
        "station responds with a one character acknowledgement. Following this the",
        "station will send a new block.",
        "In ARQ, the",
        "station transmits a block of three characters and the",
        "station responds with either a one-character acknowledgement of the receipt of a valid block or a negative acknowledgement indicating that the block should be re-sent. Following this the",
        "station will send a new block or retransmit the previous block, as required.",
    ...
    },
    {
      question: "Which of the following is true of Sitor ARQ mode:",
      options: [
        "The ship station sends a group of 3 characters twice and then waits for an",
        "signal to indicate proper receipt before continuing transmission.",
    ...
    {
      question: "Which of the following keystrokes or characters is sent as part of ARQ communications to request a direct telex call to a shore-based location?",
      options: [
        "",
        "",
        "",
    ...
    },
    {
      ...
      options: [
        ...
        "OBS+",
        "OBS+ then MSG+ to indicate weather report.",
        "GA+ then OBS+.",
      ],
      answer: 1
    },
  ...
  set31: [
    ...
    },
    {
      question: "Which of the following statements concerning SITOR communications is true?",
      options: [
        "FEC requests are first acknowledged by the vessel's transmitter before broadcasts can be received.",
        "FEC mode broadcasts can be received without the transmitter being turned on.",
        "Weather broadcasts are always made in ARQ mode to ensure reception.",
        "None of these.",
      ],
      answer: 1
    },
    ...
    },
    {
      ...
      options: [
        ...
        "Propagation",
        "are usually sufficient for routine operations.",
        "Propagation",
        "should be combined with Solar flare alerts to determine band selection.",
      ],
      answer: 2
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "Listen to shore station",
        "; choose the band with the strongest.",
